...
public class HomeWorkTests {
  ...
  public void addNewContactTest() {
    gotoAddContact();
    fillContactForms(new ContactData("Paul", "Gladoon", "Nickolayevich", "PG", "QA", "Do IT", "Pushkinskaya 63", "Odessa", "063-155-65-65", "QA", "332211", "paul.gladoon@gmail.com", "www.mypage.con", "1989", "Test Home", "No home", "No notes"));
